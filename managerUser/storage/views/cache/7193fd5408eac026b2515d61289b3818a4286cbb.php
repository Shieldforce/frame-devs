<?php $__env->startSection("content"); ?>
    <div class="container border-danger" style="border: 10px dashed red; padding: 20px;">
        <h4 class="text-danger"><span class="text-white" style="height: auto; width: auto;" title="<?php echo e($message ?? "Not get message error!"); ?>">
            Message: </span>
            <?php echo e(isset($message) ? substr($message, 0, 200)."..." : "Not get message error!"); ?>
