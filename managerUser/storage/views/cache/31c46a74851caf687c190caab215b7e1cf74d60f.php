...
<head>
    ...
    <title><?php echo e(envSystem("APP_NAME") ?? "FrameDevs"); ?></title>
    ...
    <header class="masthead mb-auto">
        <div class="inner">
            ...
            <nav class="nav nav-masthead justify-content-center">
                ...
                <a class="nav-link" href="<?php echo e(url("https://mobiconectividades.com.br")); ?>" target="_blank">Doc</a>
                <a class="nav-link" href="<?php echo e(url("https://mobiconectividades.com.br")); ?>" target="_blank">GitHub</a>
            </nav>
        </div>
    </header>
...
<?php /**PATH /home/alexandrefn/projects/frame-devs/mvc/views/site/template/index.blade.php ENDPATH**/ ?>