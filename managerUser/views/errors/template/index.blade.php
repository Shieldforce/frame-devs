...
<head>
    ...
    <title>{{ $message ?? "Mensagem de erro" }}</title>
    ...
    <header class="masthead mb-auto">
        <div class="inner">
            ...
            <nav class="nav nav-masthead justify-content-center">
                {{--<a class="nav-link active" href="{{ url("https://mobiconectividades.com.br") }}" target="_blank">Site</a>
                <a class="nav-link" href="{{ url("https://mobiconectividades.com.br") }}" target="_blank">Produtos</a>
